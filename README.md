...
Open the SQL Editor and paste the contents of supabase/schema.sql to build tables and Storage Buckets.
Retrieve your URL and Anon Key from Settings > API.
...
Click Edit on your desired course.
Enter the Meta Title, Description, and Slug.
The system will automatically render the necessary SEO tags for Google indexing.
